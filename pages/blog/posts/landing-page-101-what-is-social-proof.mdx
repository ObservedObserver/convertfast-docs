...
Add social proof components to a campaign page with a reproducible workflow:

```bash
npx convertfast-ui@latest init
npx convertfast-ui@latest page create b2b-proof
npx convertfast-ui@latest page b2b-proof add social-proof
npx convertfast-ui@latest page b2b-proof add faq
```

Example CLI output:

```text
✔ Created page: b2b-proof
✔ Added section: social-proof
✔ Added section: faq
```

Common failure case and fix:

- `Section not found: social-proof` -> update CLI to latest and re-run the add command.
