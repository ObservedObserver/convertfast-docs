...
description: "Reference for init, page create, page add, and block add in ConvertFast UI 0.2.0, including templates, overwrite rules, and registry options."
---

# CLI reference

ConvertFast UI 0.2.0 provides initialization, page generation, and standalone block installation. Run commands from your Next.js application directory. Use `npx convertfast-ui@0.2.0` instead of `@latest` when you need a reproducible package version.
