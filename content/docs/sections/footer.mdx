...
description: "Add a footer through your application layout. Footer is a historical manual example and is not an installable ConvertFast UI 0.2.0 section."
---
...
`footer` is not a supported section name for ConvertFast UI 0.2.0 `page add` or `block add`. This page preserves an older documentation URL. Footer components in the source repository are historical manual examples, not released CLI blocks.
