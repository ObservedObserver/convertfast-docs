...
description: "Set up ConvertFast UI 0.2.0 with Next.js 14, 15, or 16, TypeScript, Tailwind CSS 3 or 4, and shadcn/ui."
---
...
JSONC TypeScript configuration, inherited aliases, and custom `aliases.ui` and `aliases.utils` are supported. Aliases must resolve inside the application directory. Shared component packages outside it are unsupported in 0.2.0.
