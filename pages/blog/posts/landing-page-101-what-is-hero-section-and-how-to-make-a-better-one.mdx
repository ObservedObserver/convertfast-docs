...
Use this path when turning hero copy strategy into a production page:

```bash
npx convertfast-ui@latest init
npx convertfast-ui@latest page create growth-hero
npx convertfast-ui@latest page growth-hero add hero-section
npx convertfast-ui@latest page growth-hero add cta
```

Example CLI output:

```text
✔ Created landing-pages.json
✔ Created page: growth-hero
...
- `Error: shadcn-ui config not found` -> run shadcn initialization first, then retry `convertfast-ui init`.
