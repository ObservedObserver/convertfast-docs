...
Use this repeatable command flow to add FAQ content and schema-ready question blocks:

```bash
npx convertfast-ui@latest init
npx convertfast-ui@latest page create onboarding-faq
npx convertfast-ui@latest page onboarding-faq add faq
npx convertfast-ui@latest page onboarding-faq add cta
```

Example CLI output:

```text
✔ Created page: onboarding-faq
✔ Added section: faq
✔ Added section: cta
```
...
- FAQ section looks generic and thin -> replace placeholder questions with real support tickets or sales objections before publishing.
